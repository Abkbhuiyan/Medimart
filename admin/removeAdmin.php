          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
              <div class="box-body">
               <input type="hidden" class="form-control" value="<?php echo $rows['id'];?>"   name="id" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo $rows['fullname'];?>"   name="fullname">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="user_category" class="form-control">
                                    <option value="<?php echo $rows['user_category'];?>"> 
                                    cat  name</option>
                                    </select>
                </div>
              </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit"name="submit" class="btn btn-info pull-right">Delete </button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
