       ...
       <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                    $sql_query="SELECT * FROM `order` WHERE status='completed' ORDER BY orderId DESC";                    
                ...
                <tr>
                  ...
                  <td><?php echo $r['total']; ?> Tk</td>
                  <td>
                  <button class="btn btn-sm btn-<?php $status=$r['status'];
                  if($status=="pending"){
                    echo "pending";
                  ...
                  <td><a href="order_detail.php?orderId=<?php echo $r['orderId']; ?>">Order Details</a></td>
                </tr>
                <?php } ?>
