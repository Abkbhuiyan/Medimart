...
$rand = md5(uniqid().rand());
  $post_image = $rand.".".$ext;
   ...
   if( move_uploaded_file($tmp_file,"categoryPhoto/".$post_image)){
     $sql_query1="UPDATE `medicinecategory` SET `categoryPhoto`='$post_image' WHERE categoryId='$id'";
 }
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Medicine Category Name</h3>
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $rows['categoryName']; ?></td>
                   <td>
                   <img style="width: 80px;" src="categoryPhoto/<?php echo $rows['categoryPhoto']; ?>" />
                   
                   </td>
                   <td><?php echo $rows['categoryDescription']; ?></td>
                   <td>
                   <form action="" method="POST" enctype="multipart/form-data">
                   <input  type="hidden" name="id" value="<?php echo $rows['categoryId']; ?>"/>
                   <input type="file" name="categoryPhoto" required="" /><br />
                   <button    class="btn  btn-xs btn-info" type="submit" name="change">Change Photo</button>
                   </form>
                   </td>
                    <td style="width: 100px;">
                   <a class="btn  btn-sm  btn-warning"  href="edit_product_category.php?user_id=<?php echo $rows['categoryId']; ?>"><i class="fa fa-edit"></i></a>
                  </td>
                  <td style="width: 100px;">
                   <a class="btn  btn-sm  btn-warning"  href="deleteSomething.php?id=<?php echo $rows['categoryId']; ?>&&item=category"><i class="fa fa-trash"></i></a></td>
