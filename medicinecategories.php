        ...
        <div class="col-lg-12 no_padding bdr_all">
          ...
          <div class="main">
				<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
                    ...
                    <div class="pull-left all-p-tag "><b class="t-clr">Medicine Categories </b> </div>
					...
					<ul>
										 ...
										 <?php 
                        $sql_query="SELECT * FROM medicinecategory c  order by c.categoryName;";    
                    ...
                    //var_dump($sql_view);
                     ...
                     ?>
                        ...
                        <div class="col-sm-3 border">
                            <div class="col-item">
                                <div class="photo">
                                   <a href="categoryWiseMedicine.php?cat_id=<?php echo $r['categoryId']; ?>"> <img src="admin/categoryPhoto/<?php echo $r['categoryPhoto']; ?>" class="img-responsive" alt="a" /></a>
                                </div>
                                
                                <div class="info">
                                  <div class="row">
                                   <summary> <?php echo $r['categoryDescription']; ?></summary>
                                </div>
                                    <div class="row">
                                        <div class="price col-md-6">
                                            <h5>
                                                <?php echo $r['categoryName']; ?></h5>
                                             
                                        </div>
                                          <div class="price col-md-6">
                                            <p class="btn-details">
                                            <i class="fa fa-list"></i><a href="categoryWiseMedicine.php?cat_id=<?php echo $r['categoryId']; ?>" class="hidden-sm">Medicines</a>
                                        </p>
